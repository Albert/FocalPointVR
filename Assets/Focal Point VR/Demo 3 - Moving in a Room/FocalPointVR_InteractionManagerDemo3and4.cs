...
public class FocalPointVR_InteractionManagerDemo3and4 : MonoBehaviour {
    ...
    void applyRotation() {
        ...
        if (focalPoints.Count == 2) {
            ...
            Vector3 flatFocal0 = focalPoints[0].transform.position;
            Vector3 flatFocal1 = focalPoints[1].transform.position;
            flatFocal0.y = transform.position.y;
            flatFocal1.y = transform.position.y;
            Vector3 direction2 = flatFocal0 - flatFocal1;
            ...
            oldPointsForRotation[0] = flatFocal0;
            oldPointsForRotation[1] = flatFocal1;
